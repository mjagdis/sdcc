  ...
  cl_uc(asim)
{
  //type= CPU_TLCS;
  //sleep_executed= 0;
  regs8= new cl_address_space("regs8", 0, sizeof(reg), 8);
  regs8->init();
  regs8->decode(0, (new cl_chip_8bit("regs8", sizeof(reg), (u8_t *)&reg))->chip_init());

  regs16= new cl_address_space("regs16", 0, sizeof(reg)/2, 16);
  regs16->init();
  regs16->decode(0, (new cl_chip_16bit("regs16", sizeof(reg)/2, (u16_t *)&reg))->chip_init());
...
cl_tlcs::init(void)
{
  ...
  vars->add(v= new cl_var(cchars("A"), regs8, (u8_t *)&reg.raf.a - (u8_t *)&reg, "", 7, 0));
  v->init();
  vars->add(v= new cl_var(cchars("F"), regs8, (u8_t *)&reg.raf.f - (u8_t *)&reg, "", 7, 0));
  v->init();
  vars->add(v= new cl_var(cchars("B"), regs8, (u8_t *)&reg.rbc.b - (u8_t *)&reg, "", 7, 0));
  v->init();
  vars->add(v= new cl_var(cchars("C"), regs8, (u8_t *)&reg.rbc.c - (u8_t *)&reg, "", 7, 0));
  v->init();
  vars->add(v= new cl_var(cchars("D"), regs8, (u8_t *)&reg.rde.d - (u8_t *)&reg, "", 7, 0));
  v->init();
  vars->add(v= new cl_var(cchars("E"), regs8, (u8_t *)&reg.rde.e - (u8_t *)&reg, "", 7, 0));
  v->init();
  vars->add(v= new cl_var(cchars("H"), regs8, (u8_t *)&reg.rhl.h - (u8_t *)&reg, "", 7, 0));
  v->init();
  vars->add(v= new cl_var(cchars("L"), regs8, (u8_t *)&reg.rhl.l - (u8_t *)&reg, "", 7, 0));
  v->init();

  vars->add(v= new cl_var(cchars("ALT_A"), regs8, (u8_t *)&reg.ralt_af.alt_a - (u8_t *)&reg, "", 7, 0));
  v->init();
  vars->add(v= new cl_var(cchars("ALT_F"), regs8, (u8_t *)&reg.ralt_af.alt_f - (u8_t *)&reg, "", 7, 0));
  v->init();
  vars->add(v= new cl_var(cchars("ALT_B"), regs8, (u8_t *)&reg.ralt_bc.alt_b - (u8_t *)&reg, "", 7, 0));
  v->init();
  vars->add(v= new cl_var(cchars("ALT_C"), regs8, (u8_t *)&reg.ralt_bc.alt_c - (u8_t *)&reg, "", 7, 0));
  v->init();
  vars->add(v= new cl_var(cchars("ALT_D"), regs8, (u8_t *)&reg.ralt_de.alt_d - (u8_t *)&reg, "", 7, 0));
  v->init();
  vars->add(v= new cl_var(cchars("ALT_E"), regs8, (u8_t *)&reg.ralt_de.alt_e - (u8_t *)&reg, "", 7, 0));
  v->init();
  vars->add(v= new cl_var(cchars("ALT_H"), regs8, (u8_t *)&reg.ralt_hl.alt_h - (u8_t *)&reg, "", 7, 0));
  v->init();
  vars->add(v= new cl_var(cchars("ALT_L"), regs8, (u8_t *)&reg.ralt_hl.alt_l - (u8_t *)&reg, "", 7, 0));
  v->init();

  vars->add(v= new cl_var(cchars("AF"), regs16, (u16_t *)&reg.af - (u16_t *)&reg, "", 15, 0));
  v->init();
  vars->add(v= new cl_var(cchars("BC"), regs16, (u16_t *)&reg.bc - (u16_t *)&reg, "", 15, 0));
  v->init();
  vars->add(v= new cl_var(cchars("DE"), regs16, (u16_t *)&reg.de - (u16_t *)&reg, "", 15, 0));
  v->init();
  vars->add(v= new cl_var(cchars("HL"), regs16, (u16_t *)&reg.hl - (u16_t *)&reg, "", 15, 0));
  v->init();
  vars->add(v= new cl_var(cchars("IX"), regs16, (u16_t *)&reg.ix - (u16_t *)&reg, "", 15, 0));
  v->init();
  vars->add(v= new cl_var(cchars("IY"), regs16, (u16_t *)&reg.iy - (u16_t *)&reg, "", 15, 0));
  v->init();
  vars->add(v= new cl_var(cchars("SP"), regs16, (u16_t *)&reg.sp - (u16_t *)&reg, "", 15, 0));
  v->init();
  vars->add(v= new cl_var(cchars("ALT_AF"), regs16, (u16_t *)&reg.alt_af - (u16_t *)&reg, "", 15, 0));
  v->init();
  vars->add(v= new cl_var(cchars("ALT_BC"), regs16, (u16_t *)&reg.alt_bc - (u16_t *)&reg, "", 15, 0));
  v->init();
  vars->add(v= new cl_var(cchars("ALT_DE"), regs16, (u16_t *)&reg.alt_de - (u16_t *)&reg, "", 15, 0));
  v->init();
  vars->add(v= new cl_var(cchars("ALT_HL"), regs16, (u16_t *)&reg.alt_hl - (u16_t *)&reg, "", 15, 0));
  v->init();
