...
struct dis_entry disass_stm8[]= {
  ...
  { 0x0024, 0x00ff, 'b', 2, "jruge %p" }, // aka jrnc
  { 0x0025, 0x00ff, 'b', 2, "jrult %p" }, // aka jrc
  { 0x0026, 0x00ff, 'b', 2, "jrne %p" },
  { 0x0027, 0x00ff, 'b', 2, "jreq %p" },
  { 0x0028, 0x00ff, 'v', 2, "jrnv %p" },
  { 0x0029, 0x00ff, 'V', 2, "jrv %p" },
...
struct dis_entry disass_stm8_72[]= {
  ...
  { 0x0001, 0x00ff, 'f', 4, "btjf %x,#%B,%p" },
  { 0x0003, 0x00ff, 'f', 4, "btjf %x,#%B,%p" },
  { 0x0005, 0x00ff, 'f', 4, "btjf %x,#%B,%p" },
  { 0x0007, 0x00ff, 'f', 4, "btjf %x,#%B,%p" },
  { 0x0009, 0x00ff, 'f', 4, "btjf %x,#%B,%p" },
  { 0x000b, 0x00ff, 'f', 4, "btjf %x,#%B,%p" },
  { 0x000d, 0x00ff, 'f', 4, "btjf %x,#%B,%p" },
  { 0x000f, 0x00ff, 'f', 4, "btjf %x,#%B,%p" },

  { 0x0000, 0x00ff, 't', 4, "btjt %x,#%B,%p" },
  { 0x0002, 0x00ff, 't', 4, "btjt %x,#%B,%p" },
  { 0x0004, 0x00ff, 't', 4, "btjt %x,#%B,%p" },
  { 0x0006, 0x00ff, 't', 4, "btjt %x,#%B,%p" },
  { 0x0008, 0x00ff, 't', 4, "btjt %x,#%B,%p" },
  { 0x000a, 0x00ff, 't', 4, "btjt %x,#%B,%p" },
  { 0x000c, 0x00ff, 't', 4, "btjt %x,#%B,%p" },
  { 0x000e, 0x00ff, 't', 4, "btjt %x,#%B,%p" },
...
struct dis_entry disass_stm8_90[]= {
  ...
  // 90
  { 0x0028, 0x00ff, 'h', 2, "jrnh %p" },
  { 0x0029, 0x00ff, 'H', 2, "jrh %p" },
  { 0x002c, 0x00ff, 'b', 2, "jrnm %p" },
  { 0x002d, 0x00ff, 'b', 2, "jrm %p" },
  { 0x002e, 0x00ff, 'i', 2, "jril %p" },
  { 0x002f, 0x00ff, 'I', 2, "jrih %p" },
  // 90
