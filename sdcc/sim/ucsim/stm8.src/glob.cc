...
%B - bit number (must only occur after some other operand-setting format option)
*/
...
struct dis_entry disass_stm8[]= {
  ...
  { 0x00cd, 0x00ff, 'c', 3, "call %x", true },
  { 0x00dd, 0x00ff, 'c', 3, "call (%2,X)", true },
  { 0x00ed, 0x00ff, 'c', 2, "call (%1,X)", true },
  { 0x00fd, 0x00ff, 'c', 1, "call (X)", true },
  { 0x008d, 0x00ff, 'c', 4, "callf %e", true },
  { 0x00ad, 0x00ff, 'c', 2, "callr %p", true },
  ...
  { 0x0080, 0x00ff, 'r', 1, "iret" },

  { 0x00cc, 0x00ff, 'j', 3, "jp %x" },
  { 0x00dc, 0x00ff, 'j', 3, "jp (%2,X)" },
  { 0x00ec, 0x00ff, 'j', 2, "jp (%1,X)" },
  { 0x00fc, 0x00ff, 'j', 1, "jp (X)" },
  { 0x00ac, 0x00ff, 'j', 4, "jpf %e" },
  { 0x0020, 0x00ff, 'j', 2, "jra %p" },

  { 0x0021, 0x00ff, 'b', 2, "jrf %p" },
  { 0x0022, 0x00ff, 'b', 2, "jrugt %p" },
  { 0x0023, 0x00ff, 'b', 2, "jrule %p" },
  { 0x0024, 0x00ff, 'b', 2, "jruge %p" },
  { 0x0025, 0x00ff, 'b', 2, "jrult %p" },
  { 0x0026, 0x00ff, 'b', 2, "jrne %p" },
  { 0x0027, 0x00ff, 'b', 2, "jreq %p" },
  { 0x0028, 0x00ff, 'b', 2, "jrnv %p" },
  { 0x0029, 0x00ff, 'b', 2, "jrv %p" },
  { 0x002a, 0x00ff, 'b', 2, "jrpl %p" },
  { 0x002b, 0x00ff, 'b', 2, "jrmi %p" },
  { 0x002c, 0x00ff, 'b', 2, "jrsgt %p" },
  { 0x002d, 0x00ff, 'b', 2, "jrsle %p" },
  { 0x002e, 0x00ff, 'b', 2, "jrsge %p" },
  { 0x002f, 0x00ff, 'b', 2, "jrslt %p" },
  ...
  { 0x0098, 0x00ff, ' ', 1, "rcf" },
  { 0x0081, 0x00ff, 'r', 1, "ret" },
  { 0x0087, 0x00ff, 'r', 1, "retf" },
  { 0x009a, 0x00ff, ' ', 1, "rim" },
...
struct dis_entry disass_stm8_72[]= {
  ...
  { 0x0011, 0x00ff, ' ', 3, "bres %x,#%B" },
  { 0x0013, 0x00ff, ' ', 3, "bres %x,#%B" },
  { 0x0015, 0x00ff, ' ', 3, "bres %x,#%B" },
  { 0x0017, 0x00ff, ' ', 3, "bres %x,#%B" },
  { 0x0019, 0x00ff, ' ', 3, "bres %x,#%B" },
  { 0x001b, 0x00ff, ' ', 3, "bres %x,#%B" },
  { 0x001d, 0x00ff, ' ', 3, "bres %x,#%B" },
  { 0x001f, 0x00ff, ' ', 3, "bres %x,#%B" },

  { 0x0010, 0x00ff, ' ', 3, "bset %x,#%B" },
  { 0x0012, 0x00ff, ' ', 3, "bset %x,#%B" },
  { 0x0014, 0x00ff, ' ', 3, "bset %x,#%B" },
  { 0x0016, 0x00ff, ' ', 3, "bset %x,#%B" },
  { 0x0018, 0x00ff, ' ', 3, "bset %x,#%B" },
  { 0x001a, 0x00ff, ' ', 3, "bset %x,#%B" },
  { 0x001c, 0x00ff, ' ', 3, "bset %x,#%B" },
  { 0x001e, 0x00ff, ' ', 3, "bset %x,#%B" },

  { 0x0001, 0x00ff, 'b', 4, "btjf %x,#%B,%p" },
  { 0x0003, 0x00ff, 'b', 4, "btjf %x,#%B,%p" },
  { 0x0005, 0x00ff, 'b', 4, "btjf %x,#%B,%p" },
  { 0x0007, 0x00ff, 'b', 4, "btjf %x,#%B,%p" },
  { 0x0009, 0x00ff, 'b', 4, "btjf %x,#%B,%p" },
  { 0x000b, 0x00ff, 'b', 4, "btjf %x,#%B,%p" },
  { 0x000d, 0x00ff, 'b', 4, "btjf %x,#%B,%p" },
  { 0x000f, 0x00ff, 'b', 4, "btjf %x,#%B,%p" },

  { 0x0000, 0x00ff, 'b', 4, "btjt %x,#%B,%p" },
  { 0x0002, 0x00ff, 'b', 4, "btjt %x,#%B,%p" },
  { 0x0004, 0x00ff, 'b', 4, "btjt %x,#%B,%p" },
  { 0x0006, 0x00ff, 'b', 4, "btjt %x,#%B,%p" },
  { 0x0008, 0x00ff, 'b', 4, "btjt %x,#%B,%p" },
  { 0x000a, 0x00ff, 'b', 4, "btjt %x,#%B,%p" },
  { 0x000c, 0x00ff, 'b', 4, "btjt %x,#%B,%p" },
  { 0x000e, 0x00ff, 'b', 4, "btjt %x,#%B,%p" },

  { 0x00cd, 0x00ff, 'c', 3, "call [%2.w]", true },
  { 0x00dd, 0x00ff, 'c', 3, "call ([%2.w],X)", true },
  ...
  { 0x00cc, 0x00ff, 'j', 3, "jp [%2.w]" },
  { 0x00dc, 0x00ff, 'j', 3, "jp ([%2.w],X)" },
...
struct dis_entry disass_stm8_90[]= {
  ...
  // 90
  { 0x00dd, 0x00ff, 'c', 3, "call (%2,Y)", true },
  { 0x00ed, 0x00ff, 'c', 2, "call (%1,Y)", true },
  { 0x00fd, 0x00ff, 'c', 1, "call (Y)", true },
  // 90
  ...
  // 90
  { 0x00dc, 0x00ff, 'j', 3, "jp (%2,Y)" },
  { 0x00ec, 0x00ff, 'j', 2, "jp (%1,Y)" },
  { 0x00fc, 0x00ff, 'j', 1, "jp (Y)" },
  // 90
  { 0x0028, 0x00ff, 'b', 2, "jrnh %p" },
  { 0x0029, 0x00ff, 'b', 2, "jrh %p" },
  { 0x002c, 0x00ff, 'b', 2, "jrnm %p" },
  { 0x002d, 0x00ff, 'b', 2, "jrm %p" },
  { 0x002e, 0x00ff, 'b', 2, "jril %p" },
  { 0x002f, 0x00ff, 'b', 2, "jrih %p" },
  // 90
...
struct dis_entry disass_stm8_91[]= {
  ...
  { 0x00dd, 0x00ff, 'c', 2, "call ([%1.w],Y)", true },
...
struct dis_entry disass_stm8_92[]= {
  ...
  { 0x00cd, 0x00ff, 'c', 2, "call [%1.w]", true },
  { 0x00dd, 0x00ff, 'c', 2, "call ([%1.w],X)", true },
  { 0x008d, 0x00ff, 'c', 3, "callf [%2.e]", true },
  ...
  { 0x00cc, 0x00ff, 'j', 2, "jp [%1.w]" },
  { 0x00dc, 0x00ff, 'j', 2, "jp ([%1.w],X)" },
  { 0x00ac, 0x00ff, 'j', 3, "jpf [%2.e]" },
