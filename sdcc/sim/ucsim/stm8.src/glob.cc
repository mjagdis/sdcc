...
struct dis_entry disass_stm8_72[]= {
  ...
  { 0x0001, 0x00ff, ' ', 4, "btjf %x,#%B,%p" },
  { 0x0003, 0x00ff, ' ', 4, "btjf %x,#%B,%p" },
  { 0x0005, 0x00ff, ' ', 4, "btjf %x,#%B,%p" },
  { 0x0007, 0x00ff, ' ', 4, "btjf %x,#%B,%p" },
  { 0x0009, 0x00ff, ' ', 4, "btjf %x,#%B,%p" },
  { 0x000b, 0x00ff, ' ', 4, "btjf %x,#%B,%p" },
  { 0x000d, 0x00ff, ' ', 4, "btjf %x,#%B,%p" },
  { 0x000f, 0x00ff, ' ', 4, "btjf %x,#%B,%p" },

  { 0x0000, 0x00ff, ' ', 4, "btjt %x,#%B,%p" },
  { 0x0002, 0x00ff, ' ', 4, "btjt %x,#%B,%p" },
  { 0x0004, 0x00ff, ' ', 4, "btjt %x,#%B,%p" },
  { 0x0006, 0x00ff, ' ', 4, "btjt %x,#%B,%p" },
  { 0x0008, 0x00ff, ' ', 4, "btjt %x,#%B,%p" },
  { 0x000a, 0x00ff, ' ', 4, "btjt %x,#%B,%p" },
  { 0x000c, 0x00ff, ' ', 4, "btjt %x,#%B,%p" },
  { 0x000e, 0x00ff, ' ', 4, "btjt %x,#%B,%p" },
